          ...
          >
            ...
            <div className="container1 hero_container">
              ...
              <p className="hero_container_description">
                ...
                nhà chung của hơn 1.195 Đoàn viên và sinh viên thuộc quy tụ 22
                Chi đoàn đang học tập và sinh hoạt tại Trường Đại học Công nghệ
                Thông tin. Trong đó, 14 Chi đoàn thuộc Chương trình Đại trà, 4
                Chi đoàn thuộc Chương trình Chất lượng cao và 4 Chi đoàn thuộc
                Chương trình Tài năng. Cùng với sự phát triển của khoa, tổ chức
                Đoàn cũng đạt được những bước tiến về quy mô và chất lượng hoạt
                động.
              </p>
            </div>
          </section>
          ...
          >
            <div className="history_container">
              <p className="history_container_text">
                ...
                với Đoàn trường, được hình thành chính thức từ ngày 17/11/2014
                từ tổ chức Liên Chi đoàn khoa, trực thuộc Đoàn trường Đại học
                Công nghệ Thông tin - ĐHQG-HCM, dẫu không chỉ là nơi để các bạn
                đoàn viên trao đổi, học tập và rèn luyện mà còn là môi trường
                phát triển toàn diện về thể chất và tinh thần. Ngày nay, Đoàn
                khoa MMTT&T luôn thực hiện và hoàn thành xuất sắc các nhiệm vụ
              ...
              <div className="description_container_flex">
                ...
                >
                  <p className="description_container_flex_left_text">
                    ...
                    Chi Đoàn khoa MMT&TT không ngừng mạnh về số lượng, nâng cao
                    về chất lượng sinh hoạt Đoàn cơ sở. Đây là nơi tổ chức nhiều
                    hoạt động phong phú, từ các hoạt hội thảo, các khóa học, câu
                    lạc bộ kỹ năng đến các chương trình tình nguyện và văn nghệ.
                    Mỗi hoạt động đều mang lại cơ hội để các bạn sinh viên rèn
              ...
              <div className="leader_container_flex">
                ...
                >
                  <p className="leader_container_flex_right_text">
                    ...
                    trào thanh niên tại Trường Đại học Công nghệ Thông tin –
                    ĐHQG-HCM. Đây chính là "người bạn đồng hành" đang tin cậy
                    của sinh viên, thanh niên khoa MMT&TT, giúp các bạn sinh
                    viên phát triển toàn diện và vững bước trên con đường học
                    tập và rèn luyện.
                  </p>
                </div>
              </div>
